	...
	<div class="container">
		<div class="content">
			...
			if(isset($_GET['aksi']) == 'delete'){
				$delete = mysqli_query($con, "DELETE FROM ALESI_TUSUARIOS WHERE ID_PERSONA='$nik'");
				if($delete){
...
//								echo "Outsourcing";
			...
			<a href="mu_list.php" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Regresar</a>
