											...
											<div class="col-sm-10 col-sm-offset-1">
												...
												<div class="form-group">
													<div class="form-check-radio form-check-inline">
														...
														<label class="form-check-label">
															<input class="form-check-input" type="radio" name="CON_VIOLENCIA" id="CON_VIOLENCIA" value="S" checked="">
															<span class="form-check-sign">SI </span>
															<input class="form-check-input" type="radio" name="CON_VIOLENCIA" id="CON_VIOLENCIA" value="N" checked="">
												...
												<div class="form-group">
													<div class="form-check-radio form-check-inline">
														...
														<label class="form-check-label">
															<input class="form-check-input" type="radio" name="SIN_VIOLENCIA" id="SIN_VIOLENCIA" value="S" checked="">
															<span class="form-check-sign">SI </span>
															<input class="form-check-input" type="radio" name="SIN_VIOLENCIA" id="SIN_VIOLENCIA" value="N" checked="">
															<span class="form-check-sign">NO</span>
														</label>
													</div>
												</div>
												<div class="form-group">
													<div class="form-check-radio form-check-inline">
														...
														<label class="form-check-label">
															<input class="form-check-input" type="radio" name="EN_DOMICILIO" id="EN_DOMICILIO" value="S" checked="">
															<span class="form-check-sign">SI </span>
															<input class="form-check-input" type="radio" name="EN_DOMICILIO" id="EN_DOMICILIO" value="N" checked="">
															<span class="form-check-sign">NO</span>
														</label>
													</div>
												</div>
												<div class="form-group">
													<div class="form-check-radio form-check-inline">
														...
														<label class="form-check-label">
															<input class="form-check-input" type="radio" name="COLISION_VUELCO" id="COLISION_VUELCO" value="S" checked="">
															<span class="form-check-sign">SI </span>
															<input class="form-check-input" type="radio" name="COLISION_VUELCO" id="COLISION_VUELCO" value="N" checked="">
															<span class="form-check-sign">NO</span>
														</label>
													</div>
												</div>
