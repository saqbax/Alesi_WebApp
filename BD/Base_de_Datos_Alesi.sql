...
CREATE TABLE IF NOT EXISTS `Alesi_BD`.`Alesi_tusuarios` (
  ...
  INDEX `fk_Alesi_tusuarios_Alesi_tpersonas_idx` (`id_persona` ASC) VISIBLE,
  PRIMARY KEY (`Usuario`),
  CONSTRAINT `fk_Alesi_tusuarios_Alesi_tpersonas`
    FOREIGN KEY (`id_persona`)
    REFERENCES `Alesi_BD`.`Alesi_tpersonas` (`id_persona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Alesi_BD`.`Alesi_tcaso` (
  ...
  PRIMARY KEY (`id_caso`),
  INDEX `fk_1_idx` (`id_usuario_alta` ASC, `id_usuario_asignado` ASC, `id_usuario_ultima_act` ASC) VISIBLE,
  CONSTRAINT `fk_1`
    FOREIGN KEY (`id_usuario_alta` , `id_usuario_asignado` , `id_usuario_ultima_act`)
    REFERENCES `Alesi_BD`.`Alesi_tusuarios` (`Usuario` , `Usuario` , `Usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
